  ...
  return (
    ...
    >
      <div className="w-full h-full p-6 flex flex-col">
        ...
        {/* Navigation */}
        <div className="flex-1 overflow-y-auto custom-scrollbar pl-2 -ml-2 pb-4">
        ...
        <div className="flex-shrink-0 space-y-4 pt-6 border-t border-[var(--color-bento-border)]">
          ...
          {isAuthenticated && (
            <button 
              ...
              className="bento-btn w-full px-4 py-2 text-xs flex items-center justify-center gap-2 text-red-400 hover:text-red-300 hover:bg-red-950/30"
            >
