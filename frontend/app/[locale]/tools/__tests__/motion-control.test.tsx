...
import MotionControlPage from '../motion-control/page';
...
vi.mock('../../../../src/store/useToolsStore', () => ({
  useToolsStore: () => ({
    startMotionControl: vi.fn(),
    estimateMotionControl: vi.fn().mockResolvedValue({ estimatedCost: 1 }),
  }),
}));
