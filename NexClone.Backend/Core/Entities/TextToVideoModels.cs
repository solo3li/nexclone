...
{
    public class TextToVideoSetting
    {
        [Key]
    ...
    public class TextToVideoModelPricing : IModelPricingEntity
    {
        [Key]
        ...
        [MaxLength(50)]
        public string BillingType { get; set; } = "PerSecond"; // "PerSecond" or "PerRequest"
        ...
        // Fixed costs if BillingType == "PerRequest"
        ...
        [MaxLength(50)]
        public string AllowedWallet { get; set; } = "Premium"; // "Standard" or "Premium"
